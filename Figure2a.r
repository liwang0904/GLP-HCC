...
pdf(file.path(workdir,"Figure2a.pdf"),  onefile=FALSE, width=14, height=6.5)
...
forestplot(labeltext=tabletext, 
          ...
          title ="Incident hepatocellular carcinoma in patients with type 2 diabetes, with and without obesity \n(Comparison between propensity-score matched cohorts)", 
