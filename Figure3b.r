...
pdf(file.path(workdir,"Figure3b.pdf"),  onefile=FALSE, width=16, height=8)
...
forestplot(labeltext=tabletext, 
          ...
          title ="Hepatic decompensating events in patients with type 2 diabetes, with and without MASLD/MASH/liver fibrosis and cirrhosis \n(Comparison between propensity-score matched cohorts)", 
