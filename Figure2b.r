...
pdf(file.path(workdir,"Figure2b.pdf"),  onefile=FALSE, width=14, height=6.5)
...
forestplot(labeltext=tabletext, 
          ...
          title ="Hepatic decompensating events in patients with type 2 diabetes, with and without obesity \n(Comparison between propensity-score matched cohorts)", 
